...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="workers.php" class="flex items-center text-white active-nav-link py-4 pl-6 nav-item">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="w-full text-3xl text-black pb-6">Add Wroker</h1>
                    ...
                    <div class="w-full lg:w mt-6 pl-0 lg:pl-2">
                        ...
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl" method="POST" action="/html/database/add_worker_db.php">
                                
                                <p class="text-lg text-gray-800 font-medium  py-4">Workers information</p>

                                <div class="">
                                    <label class="block text-sm text-gray-600" for="name">Name</label>
                                    <input class="w-full px-2 py-2 text-black-700 rounded" autocomplete="off" id="name" name="name" type="text" required="">
                                </div>
                                <div class="mt-2">
                                    <label class="block text-sm text-gray-600" for="email">Email</label>
                                    <input class="w-full px-2 py-5 text-black-700 rounded" autocomplete="off" id="email" name="email" type="email" required="">
                                </div>
                                ...
                                <div class="inline-block mt-2 w-1/2 pr-1">  
                                    <input class="w-full px-2 py-2 text-black-700 rounded" type="text" autocomplete="off" maxlength="10" pattern="[1-9]{1}[0-9]{9}" title="Please enter exactly 10 digits"  required="" id="mobile" name="mobile">
                                </div>
                            ...
                            <div class="inline-block mt-2 w-1/2 pr-1">
                                ...
                                <select class="block appearance-none w-full border border-blue-500 text-black-600 py-3 px-1 pr-3 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" id="field" required name= "field">
                            ...
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                                ...
                                <div class="mt-6">
                                    ...
                                    <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="reset">RESET</button>
                                </div>
                            </form>
                        </div>
