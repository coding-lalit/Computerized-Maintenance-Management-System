        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-6">
                        ...
                        <table class="table-auto border-separate bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-center py-3 px-4 uppercase font-semibold text-sm">First Name</th>
                                    <th class="text-center py-3 px-4 uppercase font-semibold text-sm">Last Name</th>
                            ...
                            <tbody class="text-gray-700">
                                ...
                                <tr class="bg-grey-200">
                                    ...
                                    <td class="w-1/3 text-left py-3 px-4"><?php echo $row['first_name']; ?></td>
                                    <td class="w-1/3 text-left py-3 px-4"><?php echo $row['last_name']; ?></td>
                                    ...
                                    <td class="w-1/3 text-left py-3 px-4"><?php echo $row['role']; ?></td>
                                    

                                    <td><a class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 " href="/html/admin/edit user.php?id=<?php echo $row["id"]; ?>">Update</a></td>
                                    <td><a class="text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 " href="/html/database/user_delete_db.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
                    ...
                    $con = mysqli_connect('localhost', 'root', '','cmms');
                    $sql ="select * from register_info where  `id` like '%".$searchterm."%' or `first_name` like '%".$searchterm."%' or `last_name` like '%".$searchterm."%' or `email` like '%".$searchterm."%' or `mobile` like '%".$searchterm."%' or `building` like '%".$searchterm."%' or `floor` like '%".$searchterm."%' or `flat` like '%".$searchterm."%' or `role` like '%".$searchterm."%' ";
