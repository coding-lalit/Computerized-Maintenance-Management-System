                        ...
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl" method="POST" action="/html/database/new_work_db.php">
                                ...
                                <div class="">
                                    ...
                                    <input class="w-full px-5 py-1 text-black-700 bg-gray-200 rounded" autocomplete="off" id="name" name="name" type="text" required="" placeholder="Name" aria-label="Name">
                                </div>
                                <div class="mt-2">
                                    <label class="block text-sm text-gray-600" for="email">Email</label>
                                    <input class="w-full px-5  py-1 text-black-700 bg-gray-200 rounded" autocomplete="off" id="email" name="email" type="text" required="" placeholder="Email" aria-label="Email">
                                </div>
                                <div class="mt-2">
                                    <label class="block text-sm text-gray-600" for="mobile">Mobile</label>
                                    <input class="w-full px-5  py-1 text-black-700 bg-gray-200 rounded" autocomplete="off" id="mobile" name="mobile" type="text" required="" placeholder="Mobile" aria-label="Email">
                                </div>
                                <div class="mt-2">
                                    ...
                                    <div class="mt-2">
                                    <select class="block appearance-none w-full bg-gray-200 border border-blue-500 text-black-600 py-3 px-1 pr-3 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="building" name="building" placeholder="select priority">
                            ...
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                                ...
                                <div class="inline-block mt-2 w-1/2 pr-1">
                                    ...
                                    <input class="w-full px-2 py-2 text-black-700 bg-gray-200 rounded" autocomplete="off" id="floor" name="floor" type="text" required="" placeholder="Floor" aria-label="Email">
                                </div>
                                <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                                    <label class="hidden block text-sm text-gray-600" for="flat">Flat</label>
                                    <input class="w-full px-2 py-2 text-black-700 bg-gray-200 rounded" autocomplete="off" id="flat"  name="flat" type="text" required="" placeholder="Flat" aria-label="Email">
                                </div>
                            ...
                            <div class="mt-2 md:w-1/3">
                                ...
                                <select class="block appearance-none w-full bg-gray-200 border border-blue-500 text-black-600 py-3 px-1 pr-3 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" required="" id="category" name= "category" placeholder="select priority">
