            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i>Workers Table
                    </p>
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z"/>
                        ...
                        <a class=" mr-3  hover:text-blue-500 underline" href="/html/admin/new worker.php">add Worker</a>
                    </p>
                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Mobile</th>
                            ...
                            <tbody class="text-gray-700">
                                ...
                                <tr class="bg-grey-200">
                                    ...
                                    <td class="w-1/3 text-left py-3 px-4"><?php echo $row['field']; ?></td>

                                    <td><a class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 " href="/html/admin/worker_update.php?id=<?php echo $row["id"]; ?>">Update</a></td>

                                    <td><a class="text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 " href="/html/database/worker_delete_db.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
