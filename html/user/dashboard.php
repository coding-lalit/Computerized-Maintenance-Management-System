...
<body class="bg-gray-100 font-family-karla flex">
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    ...
                                    <label class="font-bold text-3xl">
                                        <?php
                                            $con = mysqli_connect('localhost', 'root', '','cmms');
                                            $sql = "SELECT * from work_info WHERE `mobile` =".$_SESSION['mobile']." AND status = 'Processing'";
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    ...
                                    <label class="font-bold text-3xl">
                                        <?php
                                            $con = mysqli_connect('localhost', 'root', '','cmms');
                                            $sql = "SELECT * from work_info WHERE `mobile` =".$_SESSION['mobile']." AND status = 'Done'";
    ...
    // Return the number of rows in result set
                        ...
                        <div class="flex space-x-4 justify-center mt-20">
                            <a href="/html/user/work order.php">
                            <button class="px-6 py-3 text-white font-light tracking-wider bg-gray-900 rounded">New Work Request</button>
                            </a>
                            <a href="/html/user/order.php">
                            <button class="px-6 py-3 text-white font-light tracking-wider bg-gray-900 rounded">View Requests</button>
                            </a>
                            <a href="/html/user/profile.php">
                            <button class="px-6 py-3 text-white font-light tracking-wider bg-gray-900 rounded">View Profile</button>
                            </a>
                        </div>
                    </div>
                </div>
