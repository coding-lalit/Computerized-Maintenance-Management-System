...
<div class="bg-white shadow overflow-y-auto sm:rounded-lg">
  ...
  <div class="border-t border-gray-200">
    ...
    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        <input class="w-full px-5  py-1 text-black-700 outline-black rounded" autocomplete="off" id="first_name" name="first_name" type="text" required="" value="<?php echo $_SESSION['first_name']?>" aria-label="First Name">
      </div>
      <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-500">Last Name</dt>
        <input class="w-full px-5  py-1 text-black-700 outline-black rounded" autocomplete="off" id="last_name" name="last_name" type="text" required="" placeholder="<?php echo $_SESSION['last_name']?>" value="<?php echo $_SESSION['last_name']?>" aria-label="Last Name">
        
      </div>
      <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-500">Email</dt>
        <input class="w-full px-5  py-1 text-black-700 bg-gray-200 rounded" autocomplete="off" id="email" name="email" type="email" readonly required="" placeholder="<?php echo $_SESSION['email']?>" value="<?php echo $_SESSION['email']?>" aria-label="Last Name">
      </div>
      <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-500">Mobile</dt>
        <input class="w-full px-5  py-1 text-black-700 bg-gray-200 outline-black rounded" autocomplete="off" id="mobile" name="mobile" type="text" maxlength="10" readonly required="" placeholder="<?php echo $_SESSION['mobile']?>" value="<?php echo $_SESSION['mobile']?>" aria-label="Last Name">
      </div>
      <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
      ...
      <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        <input class="w-full px-5  py-1 text-black-700 outline-black rounded" autocomplete="off" id="floor" name="floor" type="text" required="" placeholder="<?php echo $_SESSION['floor']?>" value="<?php echo $_SESSION['floor']?>" aria-label="Last Name">
      </div>
      <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-500">Flat</dt>
        <input class="w-full px-5  py-1 text-black-700 outline-black rounded" autocomplete="off" id="flat" name="flat" type="text" required="" placeholder="<?php echo $_SESSION['flat']?>" value="<?php echo $_SESSION['flat']?>" aria-label="Last Name">
      </div>
    </dl>
