...
<aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-10" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-10" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 w-full mt-2 origin-top-right rounded-md shadow-lg">
          <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
            <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="/html/admin/work order.php">Work Order</a>
            <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="/html/admin/request.php">Request</a>
          </div>
        </div>
            </div>
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
            <a href = "/html/home/home.php" class="mr-5 hover:text-gray-900 hover:bg-blue-400 rounded"> Home </a>
            <a href = "/html/home/howtouse.php" class="mr-5 hover:text-gray-900 hover:bg-blue-400 rounded"> How to use </a>
            <a href = "/html/home/contactus.php" class="mr-5 hover:text-gray-900 hover:bg-blue-400 rounded"> Contact us </a>
            <a href = "/html/home/about.php" class="hover:text-gray-900 hover:bg-blue-400 rounded"> About </a>
          </nav>
